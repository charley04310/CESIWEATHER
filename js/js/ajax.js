...
// ------------------  On Crée la fonction d'ouverture de la popup + connection API --------------------------------
  ...
  function SetModal(){
    ...
    // On enregistre la variable de longitude
      ...
      if (Capteur_activation == "1" ) { 
        document.getElementById("Cpt_Activation").checked = true
        document.getElementById("Cpt_Activation").setAttribute('value', '1')    
       
     }
     else{
        document.getElementById("Cpt_Activation").checked = false
        document.getElementById("Cpt_Activation").setAttribute('value', '0')
  ...
  // ---------------------   FONCTION d'implementation de valeur active' ------------------------------------
   ...
   function checkbok_activation(){
       var on_off = document.getElementById("Cpt_Activation").checked
        // On enregistre l'element HTML 
       var value_activation = document.getElementById("Cpt_Activation") 
       if(on_off == true){
...
function UpdateData(){
        ...
        var update_capteur_Activation = "0"
    ...
    function AddDataCapteur(){
     ...
     var AddData_Activation_capteur = document.getElementById("add_cpt_activation").value
